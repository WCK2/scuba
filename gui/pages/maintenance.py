...
class MAINTENANCE(NFrame):
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        self.setObjectName('page_maintenance')

        bg = QLabel(self)
        pixmap = QPixmap(vp.images + 'bg6')
        bg.setPixmap(pixmap)
        ...
        layout.addWidget(QLabel(self, objectName='G1', text='MAINTENANCE'))
        layout.addStretch()
